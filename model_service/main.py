...
from data_service.seq2seq_dataloader_base import get_data
...
def get_model(cfg):
    ...
    # 替换用法： device = int(os.environ['LOCAL_RANK'])
...
if __name__ == '__main__':
    cfg_file = os.path.join(project_path,"config_service/m1_config_base.yaml")
