...
class Seq2SeqEncoderDataset(Dataset):
    ...
    def get_seq_list(self, idx):
        ...
        # porcessed_data = seq_frame_data_df[['waypoint_x','waypoint_y']]
        # porcessed_data.to_csv('tmp/processed_data.csv')
        # 坐标点累加 end
        ...
        if self.src_frame_len > 0:
            ...
            for _, item in src_frame_data_df.iterrows():
                ...
                vel_x = item['vel_x']
                acc_x = item['acc_x']
                steer_angle = item['steer_angle']
                head_yaw_ang = item['head_yaw_ang']
                waypoint_x = item['waypoint_x']
                waypoint_y = item['waypoint_y']
